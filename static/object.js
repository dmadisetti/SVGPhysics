...
Rect.prototype._init = function(el){
	...
	this.py = this.y;
	this.padw = this.dom.width.baseVal.value/2;
	this.padh = this.dom.height.baseVal.value/2;
	this.bounds = [];
	this.points = [];
	this.bounds[0] = new Bound(this.padw,Math.PI/2); //right
	this.bounds[1] = new Bound(this.padh,0); //top
	this.bounds[2] = new Bound(this.padw,(3*Math.PI)/2); //left
	this.bounds[3] = new Bound(this.padh,Math.PI); //bottom
	this.points[0] = new Point(0,0,this);
	this.points[1] = new Point(this.padw * 2,0,this);
	this.points[2] = new Point(0,this.padh * 2,this);
	this.points[3] = new Point(this.padw * 2,this.padh * 2,this);
